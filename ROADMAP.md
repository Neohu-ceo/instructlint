...
- Configurable rule suppression with an auditable inline format
- Import-cycle detection for Claude and compatible `@path` imports
- Baseline files for gradual adoption in large repositories
- More precise path-scope models with vendor-maintained fixtures
